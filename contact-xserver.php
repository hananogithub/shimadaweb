...
// エックスサーバー対応のメールヘッダー
$headers = [
    'From' => 'info@shimadaweb.online',  // 独自ドメインのメールアドレスを使用
    'Reply-To' => $email,
    'X-Mailer' => 'PHP/' . phpversion(),
    'Content-Type' => 'text/plain; charset=UTF-8',
    'Content-Transfer-Encoding' => '8bit',
    'Return-Path' => 'info@shimadaweb.online'  // エックスサーバー用
];
...
$adminHeaders = [
    'From' => 'info@shimadaweb.online',
    'X-Mailer' => 'PHP/' . phpversion(),
    'Content-Type' => 'text/plain; charset=UTF-8',
    'Content-Transfer-Encoding' => '8bit',
    'Return-Path' => 'info@shimadaweb.online'
];
